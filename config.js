...
overlayPositions: {
  ...
  amount:         [2.8, 10.6, 12.2, 1.8],

  pipeline:       [2.8, 14.5, 12.8, 1.8],
  stage:          [2.8, 18.3, 12.8, 1.8],

  products:       [2.8, 46.5, 12.2, 1.8],
  priority:       [2.8, 56.5, 12.2, 1.8],
  forecast:       [2.8, 64.8, 12.8, 1.8],

  notes:          [2.8, 82.8, 12.2, 4.8],
  representative: [2.8, 96.0, 12.8, 1.8],
